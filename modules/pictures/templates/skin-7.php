...
name: Pictures skin 7

description: Pictures Skin 7
...
<script>
    mw.require('<?php print template_url(); ?>assets/js/justified/justifiedGallery.js');
    mw.require('<?php print template_url(); ?>assets/js/justified/justifiedGallery.min.css');
</script>
<script>
