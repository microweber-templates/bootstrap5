...
<section class="section <?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-content-skin-2-<?php print $params['id'] ?>" rel="module">
    <div class="px-4 pt-5 my-5 text-center border-bottom">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                ...
                <module type="btn" button_style="btn btn-primary btn-lg px-4 me-sm-3" button_text="Primary button"/>
