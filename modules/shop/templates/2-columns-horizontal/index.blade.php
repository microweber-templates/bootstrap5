...
name: 2 columns horizontal

description: 2 columns horizontal
        ...
        <div class="shopmag-shop-column shopmag-shop-right-column @if($products->hasFilter()) col-lg @else col-lg-12 @endif">
            ...
            <div class="row">
                @foreach($products->results() as $product)
                    <div class="col-md-6 item-{{$product->id}} mb-5">

                        <div class="product">
                            <input type="hidden" name="content_id" value="{{$product->id}}"/>

                            <a href="{{content_link($product->id)}}" class="d-flex h-100 w-100">
                                <div class="image-square-2-colums-horizontal" style="background-image: url({{$product->thumbnail(1800,2400, true)}} ">
