...
name: 3 columns horizontal

description: 3 columns horizontal
                    ...
                    <div class="col-md-4 item-{{$product->id}} mb-5">
                        ...
                        <div class="product">
                            ...
                            <a href="{{content_link($product->id)}}" class="d-flex h-100 w-100">
                                <div class="image-square-3-colums-horizontal" style="background-image: url({{$product->thumbnail(1800,2400, true)}} ">
