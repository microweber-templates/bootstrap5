            ...
            <?php foreach ($data as $item): ?>
                ...
                if ($categories) {
                    foreach ($categories as $category) {
                        $itemCats .= '<small class="text-outline-primary font-weight-bold d-block mb-2  ">' . $category['title'] . '</small> ';
                    }
                }
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col pt-3 pb-5">
                            ...
                            <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                                <a href="<?php print $item['link'] ?>" class="text-dark"><h4 class="mb-2"><?php print $item['title'] ?></h4></a>
                            <?php endif; ?>
