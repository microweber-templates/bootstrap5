        ...
        <div class="info-slider-holder container <?php if (isset($slide['images'][1])): ?> extra-img <?php else: ?> no-extra-img <?php endif; ?> h-100">
            <div class="row h-100">
                ...
                <?php if (isset($slide['images'][1])): ?>
                    <div class="info-slider-img col-12 col-md-6 text-center <?php if (isset($slide['imgPosition'])): ?><?php print $slide['imgPosition']; ?><?php endif; ?> <?php if (isset($slide['imgMainOrder']) AND $slide['imgMainOrder'] != ''): ?><?php print $slide['imgMainOrder']; ?><?php else: ?> order-1 <?php endif; ?> <?php if (isset($slide['imgLargeOrder']) AND $slide['imgLargeOrder'] != ''): ?><?php print $slide['imgLargeOrder']; ?><?php else: ?><?php endif; ?>">
                        <a href="<?php
                        if (isset($slide['url'])) {
                            print $slide['url'];
                        } else {
