    ...
    <?php else: ?>
        <div class="info-slider-holder container <?php if (isset($slide['images'][1])): ?> extra-img <?php else: ?> no-extra-img <?php endif; ?> h-100">
            <div class="row h-100">
                ...
                <?php endif; ?>
                <div class="info-slider-text col-12 <?php if (isset($slide['images'][1])): ?> col-md-6 <?php else: ?> col-lg-7 mx-auto <?php endif; ?> <?php if (isset($slide['textPosition']) AND $slide['textPosition'] != ''): ?><?php print $slide['textPosition']; ?><?php else: ?> align-self-center <?php endif; ?> <?php if (isset($slide['textLargePosition']) AND $slide['textLargePosition'] != ''): ?><?php print $slide['textLargePosition']; ?><?php else: ?> <?php endif; ?> <?php if (isset($slide['textAlign']) AND $slide['textAlign'] != ''): ?><?php print $slide['textAlign']; ?><?php else: ?> text-center <?php endif; ?> <?php if (isset($slide['textLargeAlign']) AND $slide['textLargeAlign'] != ''): ?><?php print $slide['textLargeAlign']; ?><?php else: ?><?php endif; ?> <?php if (isset($slide['imgLargeOrder']) AND $slide['imgLargeOrder'] != ''): ?> order-1 <?php else: ?> order-1 <?php endif; ?> py-6 py-md-3 px-lg-4">
